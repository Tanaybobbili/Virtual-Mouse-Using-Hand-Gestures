...
class Controller:
    ...
    def changesystembrightness():
        ...
        if isinstance(brightness_values, list) and len(brightness_values) > 0:
            current_brightness = brightness_values[0] / 100.0
        else:
            print("Error: Unable to retrieve brightness level.")
            return
        ...
        sbcontrol.fade_brightness(int(100 * current_brightness), start=brightness_values[0])
